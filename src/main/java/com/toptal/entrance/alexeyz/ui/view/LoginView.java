...
public class LoginView extends VerticalLayout {
    ...
    public LoginView() {
        ...
        Notification notification = new Notification("Welcome to AlexeyZ's Toptal Entrance Project");
    ...
    private Component buildFields() {
        ...
        signin.addClickListener((ClickListener) event ->
                JoggingEventBus.post(new Events.UserLoginRequestedEvent(username.getValue(), password.getValue()))
        );
